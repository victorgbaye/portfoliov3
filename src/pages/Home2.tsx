    ...
    <div>
        <section className="home-hero-container">
          <div className="hero">
            ...
            <h2 className="bold-text-2">Product Design Lead at Netflix, previously at Microsoft. I create delightful and intuitive human-centered experiences at scale through innovation and product strategy</h2>
          </div>
        </section>
        {/* <SkillsSection/> */}
